...
<div class="denglujiemian">
  <form action="/muduilibrary/registerServlet" method="post">
    <div class="form-group zhuti">
      <label for="exampleInputName1">姓名</label>
      <input name="reader_name" type="text" class="form-control" id="exampleInputName1" placeholder="NAME">
    </div>
    <div class="form-group zhuti">
    ...
    <div class="form-group zhuti">
      <label for="rPassword1">请再次输入密码</label>
      <input type="password" class="form-control" id="rPassword1" placeholder="password" name="password2">
    </div>
    ...
    <div class="row">
      ...
      <button type="submit" class="btn btn-default zhuti " style="margin-left: 200px;margin-top: 20px">注册</button>
    </div>
